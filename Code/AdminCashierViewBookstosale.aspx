...
myWin= open("Helpbutton.aspx?help=11", "displayWindow",
...
// -->
    ...
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Larger" Style="z-index: 100;
        left: 145px; position: absolute; top: -48px" Text="Available Books to Sale"
    ...
    <input id="Button1" style="z-index: 110; left: 496px; position: absolute; top: 7px"
    ...
    <asp:Label ID="Label4" runat="server" Style="z-index: 108; left: 210px; position: absolute;
        top: 106px" Text="Select Number of Books to Sale" Width="322px"></asp:Label>
    <br />
    ...
    <asp:Button ID="AddToCartButton" runat="server" Height="33px" OnClick="AddToCartButton_Click"
        Style="z-index: 111; left: 345px; position: absolute; top: 160px" Text="Consider for Billing"
        Width="136px" />
    <br />
    <br />
    <asp:Button ID="ViewCartButton" runat="server" Height="34px" OnClick="ViewCartButton_Click"
        Style="z-index: 112; left: 508px; position: absolute; top: 160px" Text="View and Edit the Books Added to Sale"
        Width="194px" />
    &nbsp;&nbsp;&nbsp;&nbsp;<br />
    <br />
    <br />
