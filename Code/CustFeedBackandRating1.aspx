...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            ...
            myratingDropDownList.Items.Add("2");
            myratingDropDownList.Items.Add("3");
            myratingDropDownList.Items.Add("4");
            myratingDropDownList.Items.Add("1");        
        }
    }
    ...
    {
        String str = myratingDropDownList.SelectedValue;
        int x;
        if (str.Equals("1"))
            x = 1;
            ...
            x = 4;
        float rating = 0.0f;
        rating = (int.Parse(myratingDropDownList.SelectedValue.ToString()) + float.Parse(CurrentRatingTextBox.Text) * int.Parse(BufferLabel.Text)) / (int.Parse(BufferLabel.Text) + 1);
    ...
    protected void myratingDropDownList_SelectedIndexChanged(object sender, EventArgs e)
    {
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    &nbsp;&nbsp;<br />
    <asp:DropDownList ID="myratingDropDownList" runat="server" Style="z-index: 125; left: 37px;
        position: absolute; top: 228px">
    </asp:DropDownList>
    <br />
    &nbsp;
    <asp:Button ID="RateitButton" runat="server" Style="z-index: 121; left: 239px; position: absolute;
    ...
    <br />
    <br />
    <asp:Label ID="BufferLabel" runat="server" Style="z-index: 122; left: 15px; position: absolute;
        top: 347px" Visible="False"></asp:Label>
    <br />
    <asp:Label ID="Labelc" runat="server" Style="z-index: 123; left: 7px; position: absolute;
        top: 267px" Width="289px"></asp:Label>
    <br />
    <br />
    <asp:Button ID="Button2" runat="server" Style="z-index: 124; left: 352px; position: absolute;
