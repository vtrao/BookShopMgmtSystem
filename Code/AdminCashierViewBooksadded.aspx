...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            ...
            if(something==0)
            {
                Label5.Text = "Basket is Empty! Select Books to Sale Go to View Books and Add them to Basket to Sale";
    ...
    protected void Button2_Click(object sender, EventArgs e) // update cart button
    {
        ...
        Server.Transfer("AdminCashierViewBooksadded.aspx");
    }
    ...
    {
        Server.Transfer("AdminCashierGenerateBillforshop.aspx");
    }
...
myWin= open("Helpbutton.aspx?help=10", "displayWindow",
...
// -->
    ...
    <div style="z-index: 108; left: 4px; width: 409px; position: absolute; top: 3px;
        ...
        <asp:Label ID="Label1" runat="server" Style="z-index: 100; left: 222px; position: absolute;
            top: 4px" Text="Contents of Sale basket"></asp:Label>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            CellPadding="3" DataSourceID="SqlDataSource1"
            PageSize="5" Style="z-index: 101; left: 2px; position: absolute; top: 35px" Width="591px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
        ...
        <input id="Button3" style="z-index: 102; left: 499px; position: absolute; top: 7px"
    ...
    <asp:Label ID="Label2" runat="server" Style="z-index: 108; left: 9px; position: absolute;
        top: 225px" Text="Select Book ID to Reduce the Number of Copies to Sale"
    ...
    <asp:Label ID="Label3" runat="server" Style="z-index: 113; left: 9px; position: absolute;
        top: 300px" Text="Modify the Number of Copies to Sale"></asp:Label>
    <br />
    <br />
    <asp:Button ID="Button2" runat="server" Height="31px" Style="z-index: 114; left: 40px;
        position: absolute; top: 380px" Text="Update Contents of Sale" Width="153px" OnClick="Button2_Click" />
    ...
    <asp:Button ID="gotoviewbooksButton" runat="server" OnClick="gotoviewbooksButton_Click"
        Style="z-index: 117; left: 169px; position: absolute; top: 136px" Text="Go To View Books to Sale"
